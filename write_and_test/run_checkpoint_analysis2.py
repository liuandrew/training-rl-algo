...
if __name__ == '__main__':
    ...
    all_aux_tasks = {
        'control': ['none'],
        'num': ['wall01', 'terminal'],
        'cat': ['catfacewall', 'catquad', 'catwall01'],
        'rew': ['rewexplore']        
    }
    model_folder = 'nav_4wall_batchaux/'
    checkpoint_folder = '../trained_models/checkpoint/nav_4wall_batchaux/'
    ...
    for typ in aux_types:
        ...
        for aux in tqdm(aux_tasks):
            for batch in batch_sizes:
                chks = all_chks[batch]
                trial_name = f'nav_4wall_batch{batch}aux{aux}'
